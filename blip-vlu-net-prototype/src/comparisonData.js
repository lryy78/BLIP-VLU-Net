const comparisonData = [
  ...
  // ──────────────────────────────────────────────
  { task: 'NHRBL',   dataset: 'CBSD68',        type: 'Denoise15',    vlu_psnr: 34.04, vlu_ssim: 0.9343, blip_psnr: 34.05, blip_ssim: 0.9345 },
  { task: 'NHRBL',   dataset: 'CBSD68',        type: 'Denoise25',    vlu_psnr: 31.41, vlu_ssim: 0.8918, blip_psnr: 31.39, blip_ssim: 0.8909 },
  { task: 'NHRBL',   dataset: 'CBSD68',        type: 'Denoise50',    vlu_psnr: 28.18, vlu_ssim: 0.8042, blip_psnr: 28.13, blip_ssim: 0.8013 },

  { task: 'NHRBL',   dataset: 'SOTS_outdoors', type: 'Dehazing',     vlu_psnr: 30.85, vlu_ssim: 0.9801, blip_psnr: 30.13, blip_ssim: 0.9762 },
  { task: 'NHRBL',   dataset: 'Rain100L',      type: 'Deraining',    vlu_psnr: 38.52, vlu_ssim: 0.9824, blip_psnr: 38.08, blip_ssim: 0.9808 },
  { task: 'NHRBL',   dataset: 'GoPro',         type: 'Deblurring',   vlu_psnr: 26.49, vlu_ssim: 0.8306, blip_psnr: 26.76, blip_ssim: 0.8210 },
  { task: 'NHRBL',   dataset: 'LoL',           type: 'Delowlight',   vlu_psnr: 22.38, vlu_ssim: 0.8323, blip_psnr: 22.08, blip_ssim: 0.8187 },

  { task: 'NHRBL',   dataset: 'CBSD68',        type: 'Denoise_rand', vlu_psnr: 30.93, vlu_ssim: 0.8737, blip_psnr: 30.90, blip_ssim: 0.8723 },
  { task: 'NHRBL',   dataset: 'Urban100_HR',   type: 'Denoise_rand', vlu_psnr: 31.38, vlu_ssim: 0.8953, blip_psnr: 31.58, blip_ssim: 0.9113 },
  { task: 'NHRBL',   dataset: 'Urban100_HR',   type: 'Denoise15',    vlu_psnr: 34.00, vlu_ssim: 0.9394, blip_psnr: 34.14, blip_ssim: 0.9466 },
  { task: 'NHRBL',   dataset: 'Urban100_HR',   type: 'Denoise25',    vlu_psnr: 31.47, vlu_ssim: 0.9022, blip_psnr: 31.74, blip_ssim: 0.9192 },
  { task: 'NHRBL',   dataset: 'Urban100_HR',   type: 'Denoise50',    vlu_psnr: 28.13, vlu_ssim: 0.8313, blip_psnr: 28.41, blip_ssim: 0.8592 },
  ...
  { task: 'NHR',     dataset: 'CBSD68',        type: 'Denoise50',    vlu_psnr: 28.21, vlu_ssim: 0.8045, blip_psnr: 28.17, blip_ssim: 0.8027 },

  { task: 'NHR',     dataset: 'SOTS_outdoors', type: 'Dehazing',     vlu_psnr: 30.71, vlu_ssim: 0.9793, blip_psnr: 30.60, blip_ssim: 0.9780 },
  ...
  { task: 'N',       dataset: 'Urban100_HR',  type: 'Denoise50',    vlu_psnr: 29.60, vlu_ssim: 0.8835, blip_psnr: 29.55, blip_ssim: 0.8828 },
  ...
  // Low-light (L)
  { task: 'L',       dataset: 'LoL',           type: 'Delowlight',  vlu_psnr: 22.39, vlu_ssim: 0.8223, blip_psnr: 22.83, blip_ssim: 0.8175 },
